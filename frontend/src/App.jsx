...
export default function App() {
    ...
    const fetchVertical = useCallback(async () => {
        try {
            const res = await fetch(`${API_BASE}/verticals/active`);
        ...
        <BrowserRouter>
            <div className="app-layout">
                ...
                <main className="main-content">
                    <Routes>
                        <Route path="/" element={
                            <Dashboard data={data} loading={loading} error={error} onRefresh={fetchDashboard} vertical={vertical} t={t} />
                        } />
                        <Route path="/data" element={<DataManager vertical={vertical} t={t} />} />
                        <Route path="/simulator" element={<Simulator dashboardData={data} vertical={vertical} t={t} />} />
                        ...
                        <Route path="/reports" element={<Reports vertical={vertical} t={t} />} />
                        <Route path="/settings" element={<Settings vertical={vertical} onRefreshVertical={fetchVertical} />} />
                    </Routes>
                </main>
            </div>
        </BrowserRouter>
